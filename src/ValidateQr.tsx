  ...
  return (
    <>
      ...
      <div className="p-2 text-center max-w-xl mx-auto">
        ...
        {/* LISTA DE INVITADOS */}
        <input type="checkbox" id="modal_invitados" className="modal-toggle" />
                  ...
                  .map((invitado, index) => (
                    ...
                    >
                      ...
                      <div className="list-col-grow">
                        <div className="font-semibold">{invitado.nombre}</div>
                      ...
                      {!invitado.AsistenciaEscaneada && (
                        <button
                          ...
                          onClick={() => handleClickConfirm(invitado)}
                        >
          ...
          {!cameraError ? (
            ...
            <div className="text-center py-8">
              <p className="text-red-700 font-bold mb-2">
                ...
                <br />
                Verifica los permisos del navegador, que el sitio esté en HTTPS
                y que la cámara no esté siendo usada por otra app.
              </p>
              <button
